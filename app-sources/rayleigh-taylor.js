...
export const RT_CONFIG = Object.freeze({
    ...
    atwood: 0.5, // Density tests: 0, 0.1, 0.5, and 0.8.
    gravity: -1,
...
export const RT_RESOLUTIONS = Object.freeze([
...
export const RT_HISTORY_BYTES = 128 * 1000 * 1000;
...
export function rtLayout(resolution, overrides = {}) {
    ...
    const historyLimit = Math.min(cfg.maxSnapshots, Math.floor(RT_HISTORY_BYTES / snapshotBytes));
    return {
        cfg,
        nx,
        ny,
...
export const RT_PALETTES = Object.freeze({
...
export const RT_VERTEX = `#version 300 es
void main() {
...
export class RTSolver {
    constructor(canvas, resolution = 128, overrides = {}) {
        this.layout = rtLayout(resolution, overrides);
        this.canvas = canvas;
        ...
        this.historyError = '';
        this.viewIndex = -1;
        this.palette = RT_PALETTES['red-blue'];
        ...
        try {
            ...
            for (const [name, source] of Object.entries(RT_SHADERS))
